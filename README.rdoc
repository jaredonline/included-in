...
It reads "If the array contains this string", when the real question is, "If the string is included in the array".  The first sentence puts the importance on the array, the second is more concerned with the array. With Included-In it would look like
